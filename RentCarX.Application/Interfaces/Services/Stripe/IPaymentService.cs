...
namespace RentCarX.Domain.Interfaces.Services.Stripe
{
    public interface IPaymentService
    {
        ...
        Task HandleRefundSucceededAsync(string refundId, bool sendEmail, string? paymentIntentId = null, long? amount = null, string? currency = null, CancellationToken ct = default);
